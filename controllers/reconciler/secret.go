...
func (s *Secret) Create(instance *neo4jv1alpha1.Neo4jCluster) (MetaObject, error) {
...
func (s *Secret) Update(instance *neo4jv1alpha1.Neo4jCluster, found runtime.Object) (MetaObject, bool, error) {
	other := found.(*core.Secret)
	return other, false, nil
}

func (s *Secret) GetName(instance *neo4jv1alpha1.Neo4jCluster) string {
...
func buildSecret(instance *neo4jv1alpha1.Neo4jCluster) (*core.Secret, error) {
